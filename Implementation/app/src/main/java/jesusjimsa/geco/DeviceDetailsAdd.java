...
public class DeviceDetailsAdd extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_device_details_add);
		...
		CustomList adapter = new CustomList(DeviceDetailsAdd.this, gestures, imageId);
		list = findViewById(R.id.gestures_list);
		list.setAdapter(adapter);
		list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			@Override
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				Intent intent = new Intent(DeviceDetailsAdd.this, GestureDetails.class);
		...
		Button add_device = findViewById(R.id.add);
