...
public class MainSimulation extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_main_simulation);
		...
		connected_devices_grid.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
				Intent intent = new Intent(MainSimulation.this, DeviceDetails.class);
				String device_name = "";
		...
		add_button.setOnClickListener(new View.OnClickListener(){
			public void onClick(View v) {
				Intent intent = new Intent(MainSimulation.this, AvailableDevices.class);
				startActivity(intent);
			}
		});
	}
	...
	private void initializeGrid(){
		...
		image_adapter_main.addItem(R.drawable.ipod);
